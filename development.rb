dep 'prepare-deploy', :app_name, :git_username, :server_ip, :app_path, :app_type, :ruby_version, :use_faye, :database do
  ...
  requires 'autobackup'.with(app_name, app_path, ruby_version, database)
